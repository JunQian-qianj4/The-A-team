...
%% Vehicle Mechanical
chassisMass = 75;       % kg
battery_weight = 88.36; % Kg
electric_weight = 27.7; % kg
curbMass = chassisMass + battery_weight + electric_weight;
riderMass = 70;         % kg
...
v_rated = 72;  % rated voltage
t_rated = 86/0.73756214836955;  % continuous rated torque
i_peak = 500;    % peak current
p_rated = i_peak * v_rated;
%% define basic parameters
wr = p_rated/t_rated;   % rated rotor angular speed
wmr = wr / Ngb;         % rated motor angular speed
vmr = wmr*rw;           % rated vehicle speed
vts = 150/3.6;          % setup the top speed(m/s)
t(1) = 0;
dt = 0.1;
vm(1) = 0;
i = 1;
...
i_datasheet = 550;
v_datasheet = 72;
p_datasheet = i_datasheet * v_datasheet;
i_test = 494.9;
v_test = 75.25;
p_test = i_test * v_test;
eff = p_test/p_datasheet;
fprintf('The calculated electric macine efficiency is: %.1f%% \n',eff*100);
